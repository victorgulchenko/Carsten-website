...
### Cursor
- **Kurz:** KI-Code-Editor, stärkere Alternative zu Copilot.
- **Erklärung:** Eine Entwicklungsumgebung, in der die KI tief integriert ist – Vorschläge, ganze Funktionen, Umbauten über mehrere Dateien hinweg.
- **Im Mentoring:** Als Option neben GitHub Copilot genannt.
- **Link:** https://cursor.com
- **Tags:** coding, editor

### GitHub Copilot
- **Kurz:** KI-Assistent fürs Programmieren, von GitHub.
- **Erklärung:** In eurer KfW-Umgebung mit verschiedenen Modellen im Einsatz, mit einem Kontextlimit von ca. 250.000 Token (beim SAS2Python-Task zeitweise zu ~80 % genutzt).
- **Im Mentoring:** Euer aktuelles Tool; Ausgangspunkt für den Vergleich mit Cursor/Claude Code.
- **Link:** https://github.com/features/copilot
- **Tags:** coding, kfw

### Claude
- **Kurz:** KI-Assistent von Anthropic.
- **Erklärung:** Stark in deutscher Sprache, beim Reasoning und bei langen Dokumenten. Gut für Recherche, Zusammenfassungen und Textentwürfe.
- **Im Mentoring:** Grundlage vieler unserer Beispiele.
- **Link:** https://claude.ai
- **Tags:** assistent, text

### ChatGPT
- **Kurz:** KI-Assistent von OpenAI.
- **Erklärung:** Vielseitiger Assistent, kann u. a. auch „Deep Research" – also längere, mehrstufige Recherche selbstständig durchführen.
- **Im Mentoring:** Als Beispiel für Deep-Research-Agenten genannt.
- **Link:** https://chatgpt.com
- **Tags:** assistent, recherche
...
### AWS Bedrock
- **Kurz:** Gemanagtes Hosting von KI-Modellen (u. a. Claude) bei AWS.
- **Erklärung:** Modelle laufen in der eigenen Cloud-Umgebung – relevant für die „bleibt in unserer VPC"-Frage, die in regulierten Häusern wie der KfW zählt.
- **Im Mentoring:** Als Weg genannt, KI sicher und kontrolliert zu betreiben.
- **Link:** https://aws.amazon.com/bedrock/
- **Tags:** inferenz, sicherheit, cloud
...
### The Decoder
- **Kurz:** Deutschsprachige KI-News.
- **Erklärung:** Fundierte, aktuelle Berichterstattung zu KI auf Deutsch – gut für den Überblick.
- **Link:** https://the-decoder.de
- **Tags:** news, deutsch

### Heise online
- **Kurz:** Deutsche Tech-News mit solidem KI-Teil.
- **Erklärung:** Etablierte Quelle für Technik und IT, oft mit kritischer Einordnung.
- **Link:** https://www.heise.de
- **Tags:** news, deutsch

### t3n
- **Kurz:** Deutsches Digital-/Tech-Magazin.
- **Erklärung:** Praxisnahe Artikel zu KI, Tools und digitaler Arbeit.
- **Link:** https://t3n.de
- **Tags:** news, deutsch

### Anbieter-Blogs (Anthropic, OpenAI, Google)
- **Kurz:** Primärquellen für neue Releases.
- **Erklärung:** Ankündigungen und technische Details aus erster Hand – nützlich, um Hype von Substanz zu trennen.
- **Link:** https://www.anthropic.com/news
- **Tags:** news, primärquelle
